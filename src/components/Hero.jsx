...
const floatingCards = [
  // 1. Founder Portrait - Top Left
  {
    ...
    className: 'top-[12%] left-[6%] w-[180px] md:w-[240px] aspect-[3/4] z-10',
    parallaxSpeed: -60,
    mouseFactor: 0.015,
    overlay: {
      img: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=300&h=300&q=80',
      className: 'absolute -bottom-8 -left-8 w-24 h-24 md:w-32 md:h-32 border border-white/10 shadow-2xl rounded-sm overflow-hidden z-20',
      parallaxSpeed: -30,
    }
  },
  // 2. Modern City Skyline - Top Right
  {
    ...
    className: 'top-[10%] right-[6%] w-[260px] md:w-[380px] aspect-[16/10] z-10',
    parallaxSpeed: -40,
    mouseFactor: 0.01,
  },
  // 3. Luxury Villa Mockup - Bottom Left
  {
    ...
    className: 'bottom-[12%] left-[4%] w-[280px] md:w-[400px] aspect-[16/10] z-20',
    parallaxSpeed: 40,
    mouseFactor: 0.012,
  },
  // 4. Mobile App / Headphone Portrait - Bottom Right
  {
    ...
    className: 'bottom-[12%] right-[14%] w-[200px] md:w-[280px] aspect-[1.4/1] z-20',
    parallaxSpeed: 30,
    mouseFactor: 0.015,
    overlay: {
      img: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=400&h=300&q=80',
      className: 'absolute -top-12 -right-8 w-24 h-32 md:w-32 md:h-40 border border-white/10 shadow-2xl rounded-sm overflow-hidden z-30',
      parallaxSpeed: 60,
    }
  },
  // Extra card A: Branding visual - Center Left
  {
    ...
    className: 'top-[42%] left-[1%] w-[110px] md:w-[150px] aspect-square z-5 opacity-40 hover:opacity-100 transition-opacity duration-300',
    parallaxSpeed: -10,
    mouseFactor: 0.005,
  },
  // Extra card B: Analytics dashboard - Center Right
  {
    ...
    className: 'top-[45%] right-[2%] w-[130px] md:w-[180px] aspect-[1.4/1] z-5 opacity-40 hover:opacity-100 transition-opacity duration-300',
    parallaxSpeed: 20,
    mouseFactor: 0.007,
  }
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center text-center select-none pt-12 pb-24 md:py-0">
        ...
        >
          Building <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-[#a6a6a6]">Digital</span> <br />
          Products <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange via-brand-glow to-brand-light">That Scale</span>
        </motion.h1>
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none hidden md:block">
        {floatingCards.map((card) => {
          ...
          const yScroll = useTransform(scrollYProgress, [0, 1], [0, card.parallaxSpeed]);
          const xMouse = useTransform(mouseX, (x) => x * card.mouseFactor);
          const yMouse = useTransform(mouseY, (y) => y * card.mouseFactor);
          ...
          return (
            <motion.div
              ...
              transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1], delay: 0.5 + Math.random() * 0.3 }}
            ...
            >
              ...
              {card.overlay && (
                <motion.div
                  style={{
                    y: useTransform(scrollYProgress, [0, 1], [0, card.overlay.parallaxSpeed]),
                    x: useTransform(mouseX, (x) => x * card.mouseFactor * 1.5),
                  }}
      ...
      <div className="w-full px-6 grid grid-cols-2 gap-4 pb-20 md:hidden relative z-30">
        <div className="space-y-4">
          ...
          >
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&h=533&q=80" alt="Founder" className="w-full h-full object-cover grayscale" />
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=400&h=250&q=80" alt="Mockup" className="w-full h-full object-cover grayscale" />
          </motion.div>
        </div>
        <div className="space-y-4 pt-8">
          <motion.div 
            ...
            className="w-full aspect-[16/10] rounded-sm overflow-hidden border border-white/10"
          >
            <img src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=400&h=250&q=80" alt="Skyline" className="w-full h-full object-cover grayscale" />
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <img src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?auto=format&fit=crop&w=400&h=286&q=80" alt="Mobile" className="w-full h-full object-cover grayscale" />
          </motion.div>
        </div>
      </div>
    </section>
