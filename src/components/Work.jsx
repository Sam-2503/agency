...
export default function Work() {
  return (
    <section id="work" className="relative py-24 md:py-32 bg-[#050505] overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-6">
          <div className="space-y-4 max-w-xl">
            ...
            >
              Featured <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-brand-light">Client Work</span>
            </motion.h2>
          </div>
          ...
          >
            A curated selection of digital products built to scale businesses, streamline operations, and engage users.
          </motion.div>
        </div>
